...
export default function ConfiguracaoPendente() {
  return (
    <div className="flex min-h-dvh items-center justify-center bg-hub-gray-light p-6">
      <div className="w-full max-w-lg rounded-lg border border-amber-300 bg-white p-6 shadow-sm">
        <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-amber-100">
          <AlertTriangle className="h-6 w-6 text-amber-600" />
        </div>
        <h1 className="text-xl font-bold text-hub-blue-dark">
        ...
        <p className="mt-4 text-xs text-muted-foreground">
          O passo a passo completo de provisionamento do banco está em{" "}
