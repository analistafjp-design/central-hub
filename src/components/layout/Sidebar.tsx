...
export function Sidebar() {
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-hub-gray-border bg-hub-blue-dark text-white lg:flex">
      ...
      <div className="border-t border-white/10 p-4 text-center text-[11px] text-white/40">
        {APP_NAME} © {new Date().getFullYear()} — Todos os direitos reservados
      </div>
    </aside>
  );
}
